#ifndef CPYRT_CPPINSTANCE_H
#define CPYRT_CPPINSTANCE_H
...
template <typename T> inline bool CPPInstance_Check(T* object) {
  ...
  // subclasses of CPPInstance inherit.
  return object && (Py_TYPE(object)->tp_new == CPPInstance_Type.tp_new ||
                    PyObject_TypeCheck(object, &CPPInstance_Type));
}
#endif

template <typename T> inline bool CPPInstance_CheckExact(T* object) {
