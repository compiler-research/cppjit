...
CPPJIT_IMPL_GILCALL(int,            I)
CPPJIT_IMPL_GILCALL(long,           L)
CPPJIT_IMPL_GILCALL(PY_LONG_LONG,   LL)
CPPJIT_IMPL_GILCALL(float,          F)
CPPJIT_IMPL_GILCALL(double,         D)
CPPJIT_IMPL_GILCALL(PY_LONG_DOUBLE, LD)
CPPJIT_IMPL_GILCALL(void*,          R)
// clang-format on

static inline interop::TCppObject_t GILCallO(interop::TCppMethod_t method,
                                             interop::TCppObject_t self,
                                             cpyrt::CallContext* ctxt,
...
cpyrt::Executor::~Executor() { /* empty */ }

//- executors for built-ins --------------------------------------------------
PyObject* cpyrt::BoolExecutor::Execute(interop::TCppMethod_t method,
                                       interop::TCppObject_t self,
                                       CallContext* ctxt) {
  // execute <method> with argument <self, ctxt>, construct python bool return
  // value
...
//----------------------------------------------------------------------------
PyObject* cpyrt::BoolConstRefExecutor::Execute(interop::TCppMethod_t method,
                                               interop::TCppObject_t self,
                                               CallContext* ctxt) {
  // execute <method> with argument <self, ctxt>, construct python bool return
  // value
  return cpyrt_PyBool_FromLong(*((bool*)GILCallR(method, self, ctxt)));
}

//----------------------------------------------------------------------------
PyObject* cpyrt::CharExecutor::Execute(interop::TCppMethod_t method,
                                       interop::TCppObject_t self,
                                       CallContext* ctxt) {
  // execute <method with argument <self, ctxt>, construct python string return
  // value with the single char
  return cpyrt_PyText_FromLong((int)GILCallC(method, self, ctxt));
}

//----------------------------------------------------------------------------
PyObject* cpyrt::CharConstRefExecutor::Execute(interop::TCppMethod_t method,
                                               interop::TCppObject_t self,
                                               CallContext* ctxt) {
  // execute <method> with argument <self, ctxt>, construct python string return
  // value with the single char
  return cpyrt_PyText_FromLong(*((char*)GILCallR(method, self, ctxt)));
}

//----------------------------------------------------------------------------
PyObject* cpyrt::UCharExecutor::Execute(interop::TCppMethod_t method,
                                        interop::TCppObject_t self,
                                        CallContext* ctxt) {
  // execute <method> with argument <self, args>, construct python string return
  // value with the single char
  return cpyrt_PyText_FromLong((unsigned char)GILCallB(method, self, ctxt));
}

//----------------------------------------------------------------------------
PyObject* cpyrt::UCharConstRefExecutor::Execute(interop::TCppMethod_t method,
                                                interop::TCppObject_t self,
                                                CallContext* ctxt) {
  // execute <method> with argument <self, ctxt>, construct python string return
  // value with the single char from the pointer return
  return cpyrt_PyText_FromLong(*((unsigned char*)GILCallR(method, self, ctxt)));
}
...
//----------------------------------------------------------------------------
PyObject* cpyrt::WCharExecutor::Execute(interop::TCppMethod_t method,
                                        interop::TCppObject_t self,
                                        CallContext* ctxt) {
  // execute <method> with argument <self, args>, construct python string return
  // value with the single wide char
  wchar_t res = (wchar_t)GILCallL(method, self, ctxt);
  return PyUnicode_FromWideChar(&res, 1);
}

//----------------------------------------------------------------------------
PyObject* cpyrt::Char16Executor::Execute(interop::TCppMethod_t method,
                                         interop::TCppObject_t self,
                                         CallContext* ctxt) {
  // execute <method> with argument <self, args>, construct python string return
  // value with the single char16
  char16_t res = (char16_t)GILCallL(method, self, ctxt);
  return PyUnicode_DecodeUTF16((const char*)&res, sizeof(char16_t), nullptr,
                               nullptr);
}

//----------------------------------------------------------------------------
PyObject* cpyrt::Char32Executor::Execute(interop::TCppMethod_t method,
                                         interop::TCppObject_t self,
                                         CallContext* ctxt) {
  // execute <method> with argument <self, args>, construct python string return
  // value with the single char32
  char32_t res = (char32_t)GILCallL(method, self, ctxt);
  return PyUnicode_DecodeUTF32((const char*)&res, sizeof(char32_t), nullptr,
                               nullptr);
}

//----------------------------------------------------------------------------
PyObject* cpyrt::IntExecutor::Execute(interop::TCppMethod_t method,
                                      interop::TCppObject_t self,
                                      CallContext* ctxt) {
...
//----------------------------------------------------------------------------
PyObject* cpyrt::Int8Executor::Execute(interop::TCppMethod_t method,
                                       interop::TCppObject_t self,
                                       CallContext* ctxt) {
  // execute <method> with argument <self, ctxt>, construct python int return
  // value
...
//----------------------------------------------------------------------------
PyObject* cpyrt::UInt8Executor::Execute(interop::TCppMethod_t method,
                                        interop::TCppObject_t self,
                                        CallContext* ctxt) {
  // execute <method> with argument <self, ctxt>, construct python int return
  // value
...
//----------------------------------------------------------------------------
PyObject* cpyrt::ShortExecutor::Execute(interop::TCppMethod_t method,
                                        interop::TCppObject_t self,
                                        CallContext* ctxt) {
  // execute <method> with argument <self, ctxt>, construct python int return
  // value
...
//----------------------------------------------------------------------------
PyObject* cpyrt::LongExecutor::Execute(interop::TCppMethod_t method,
                                       interop::TCppObject_t self,
                                       CallContext* ctxt) {
  // execute <method> with argument <self, ctxt>, construct python long return
  // value
  return PyLong_FromLong((long)GILCallL(method, self, ctxt));
}

//----------------------------------------------------------------------------
PyObject* cpyrt::ULongExecutor::Execute(interop::TCppMethod_t method,
                                        interop::TCppObject_t self,
                                        CallContext* ctxt) {
  // execute <method> with argument <self, ctxt>, construct python unsigned long
  // return value
  return PyLong_FromUnsignedLong((unsigned long)GILCallLL(method, self, ctxt));
}

//----------------------------------------------------------------------------
PyObject* cpyrt::LongLongExecutor::Execute(interop::TCppMethod_t method,
                                           interop::TCppObject_t self,
                                           CallContext* ctxt) {
  // execute <method> with argument <self, ctxt>, construct python long long
  // return value
...
//----------------------------------------------------------------------------
PyObject* cpyrt::ULongLongExecutor::Execute(interop::TCppMethod_t method,
                                            interop::TCppObject_t self,
                                            CallContext* ctxt) {
  // execute <method> with argument <self, ctxt>, construct python unsigned long
  // long return value
...
//----------------------------------------------------------------------------
PyObject* cpyrt::FloatExecutor::Execute(interop::TCppMethod_t method,
                                        interop::TCppObject_t self,
                                        CallContext* ctxt) {
  // execute <method> with argument <self, ctxt>, construct python float return
  // value
  return PyFloat_FromDouble((double)GILCallF(method, self, ctxt));
}

//----------------------------------------------------------------------------
PyObject* cpyrt::DoubleExecutor::Execute(interop::TCppMethod_t method,
                                         interop::TCppObject_t self,
                                         CallContext* ctxt) {
  // execute <method> with argument <self, ctxt>, construct python float return
  // value
...
//----------------------------------------------------------------------------
PyObject* cpyrt::LongDoubleExecutor::Execute(interop::TCppMethod_t method,
                                             interop::TCppObject_t self,
                                             CallContext* ctxt) {
  // execute <method> with argument <self, ctxt>, construct python float return
  // value
...
//----------------------------------------------------------------------------
bool cpyrt::RefExecutor::SetAssignable(PyObject* pyobject) {
...
//----------------------------------------------------------------------------
#define CPPJIT_IMPL_REFEXEC(name, type, stype, F1, F2)                         \
  PyObject* cpyrt::name##RefExecutor::Execute(interop::TCppMethod_t method,    \
                                              interop::TCppObject_t self,      \
                                              CallContext* ctxt) {             \
...
CPPJIT_IMPL_REFEXEC(LongLong,   PY_LONG_LONG,   PY_LONG_LONG,   PyLong_FromLongLong,         PyLong_AsLongLong)
CPPJIT_IMPL_REFEXEC(ULongLong,  PY_ULONG_LONG,  PY_ULONG_LONG,  PyLong_FromUnsignedLongLong, PyLongOrInt_AsULong64)
CPPJIT_IMPL_REFEXEC(Float,      float,          double,         PyFloat_FromDouble,          PyFloat_AsDouble)
CPPJIT_IMPL_REFEXEC(Double,     double,         double,         PyFloat_FromDouble,          PyFloat_AsDouble)
CPPJIT_IMPL_REFEXEC(LongDouble, PY_LONG_DOUBLE, PY_LONG_DOUBLE, PyFloat_FromDouble,          PyFloat_AsDouble)
// clang-format on
...
CPPJIT_IMPL_REFEXEC(ComplexD, std::complex<double>, std::complex<double>,
                    PyComplex_FromComplex<double>, PyComplex_AsComplex<double>)

//----------------------------------------------------------------------------
PyObject* cpyrt::STLStringRefExecutor::Execute(interop::TCppMethod_t method,
                                               interop::TCppObject_t self,
                                               CallContext* ctxt) {
...
//----------------------------------------------------------------------------
PyObject* cpyrt::VoidExecutor::Execute(interop::TCppMethod_t method,
                                       interop::TCppObject_t self,
                                       CallContext* ctxt) {
...
//----------------------------------------------------------------------------
PyObject* cpyrt::CStringExecutor::Execute(interop::TCppMethod_t method,
                                          interop::TCppObject_t self,
                                          CallContext* ctxt) {
  // execute <method> with argument <self, ctxt>, construct python string return
  // value
...
//----------------------------------------------------------------------------
PyObject* cpyrt::CStringRefExecutor::Execute(interop::TCppMethod_t method,
                                             interop::TCppObject_t self,
                                             CallContext* ctxt) {
  // execute <method> with argument <self, ctxt>, construct python string return
  // value
...
//----------------------------------------------------------------------------
PyObject* cpyrt::WCStringExecutor::Execute(interop::TCppMethod_t method,
                                           interop::TCppObject_t self,
                                           CallContext* ctxt) {
  // execute <method> with argument <self, ctxt>, construct python unicode
  // return value
...
//----------------------------------------------------------------------------
PyObject* cpyrt::CString16Executor::Execute(interop::TCppMethod_t method,
                                            interop::TCppObject_t self,
                                            CallContext* ctxt) {
  // execute <method> with argument <self, ctxt>, construct python unicode
  // return value
  ...
  return PyUnicode_DecodeUTF16((const char*)result,
                               std::char_traits<char16_t>::length(result) *
                                   sizeof(char16_t),
                               nullptr, nullptr);
}

//----------------------------------------------------------------------------
PyObject* cpyrt::CString32Executor::Execute(interop::TCppMethod_t method,
                                            interop::TCppObject_t self,
                                            CallContext* ctxt) {
  // execute <method> with argument <self, ctxt>, construct python unicode
  // return value
  ...
  return PyUnicode_DecodeUTF32((const char*)result,
                               std::char_traits<char32_t>::length(result) *
                                   sizeof(char32_t),
                               nullptr, nullptr);
}

//- pointer/array executors --------------------------------------------------
PyObject* cpyrt::VoidArrayExecutor::Execute(interop::TCppMethod_t method,
                                            interop::TCppObject_t self,
                                            CallContext* ctxt) {
  // execute <method> with argument <self, ctxt>, construct python long return
  // value
...
//----------------------------------------------------------------------------
#define CPPJIT_IMPL_ARRAY_EXEC(name, type, suffix)                             \
  PyObject* cpyrt::name##ArrayExecutor::Execute(interop::TCppMethod_t method,  \
                                                interop::TCppObject_t self,    \
                                                CallContext* ctxt) {           \
    return CreateLowLevelView##suffix((type*)GILCallR(method, self, ctxt),     \
                                      fShape);                                 \
  }

// clang-format off
CPPJIT_IMPL_ARRAY_EXEC(Bool,     bool,                    )
CPPJIT_IMPL_ARRAY_EXEC(SChar,    signed char,             )
CPPJIT_IMPL_ARRAY_EXEC(UChar,    unsigned char,           )
CPPJIT_IMPL_ARRAY_EXEC(Byte,     std::byte,               )
CPPJIT_IMPL_ARRAY_EXEC(Int8,     int8_t,               _i8)
CPPJIT_IMPL_ARRAY_EXEC(UInt8,    uint8_t,              _i8)
CPPJIT_IMPL_ARRAY_EXEC(Short,    short,                   )
CPPJIT_IMPL_ARRAY_EXEC(UShort,   unsigned short,          )
CPPJIT_IMPL_ARRAY_EXEC(Int,      int,                     )
CPPJIT_IMPL_ARRAY_EXEC(UInt,     unsigned int,            )
CPPJIT_IMPL_ARRAY_EXEC(Long,     long,                    )
CPPJIT_IMPL_ARRAY_EXEC(ULong,    unsigned long,           )
CPPJIT_IMPL_ARRAY_EXEC(LLong,    long long,               )
CPPJIT_IMPL_ARRAY_EXEC(ULLong,   unsigned long long,      )
CPPJIT_IMPL_ARRAY_EXEC(Float,    float,                   )
CPPJIT_IMPL_ARRAY_EXEC(Double,   double,                  )
CPPJIT_IMPL_ARRAY_EXEC(LDouble,  long double,             )
CPPJIT_IMPL_ARRAY_EXEC(ComplexF, std::complex<float>,     )
CPPJIT_IMPL_ARRAY_EXEC(ComplexD, std::complex<double>,    )
CPPJIT_IMPL_ARRAY_EXEC(ComplexI, std::complex<int>,       )
CPPJIT_IMPL_ARRAY_EXEC(ComplexL, std::complex<long>,      )
// clang-format on

//- special cases ------------------------------------------------------------
#define CPPJIT_COMPLEX_EXEC(code, type)                                        \
  PyObject* cpyrt::Complex##code##Executor::Execute(                           \
      interop::TCppMethod_t method, interop::TCppObject_t self,                \
      CallContext* ctxt) {                                                     \
    static interop::TCppScope_t scopeid =                                      \
        interop::GetScope("std::complex<" #type ">");                          \
    ...
    ::operator delete(result); /* interop::CallO calls ::operator new */       \
    return pyres;                                                              \
  }

CPPJIT_COMPLEX_EXEC(D, double)

//----------------------------------------------------------------------------
PyObject* cpyrt::STLStringExecutor::Execute(interop::TCppMethod_t method,
                                            interop::TCppObject_t self,
                                            CallContext* ctxt) {
  // execute <method> with argument <self, ctxt>, construct python string return
  // value
...
//----------------------------------------------------------------------------
PyObject* cpyrt::STLWStringExecutor::Execute(interop::TCppMethod_t method,
                                             interop::TCppObject_t self,
                                             CallContext* ctxt) {
  // execute <method> with argument <self, ctxt>, construct python string return
  // value
  static interop::TCppScope_t sSTLWStringScope =
      interop::GetFullScope("std::wstring");
  std::wstring* result =
...
//----------------------------------------------------------------------------
PyObject* cpyrt::InstancePtrExecutor::Execute(interop::TCppMethod_t method,
                                              interop::TCppObject_t self,
                                              CallContext* ctxt) {
  // execute <method> with argument <self, ctxt>, construct python proxy object
  // return value
  return BindCppObject((void*)GILCallR(method, self, ctxt), fClass);
}

//----------------------------------------------------------------------------
cpyrt::InstanceExecutor::InstanceExecutor(interop::TCppScope_t klass)
    : fClass(klass), fFlags(CPPInstance::kIsValue | CPPInstance::kIsOwner) {
  /* empty */
}

//----------------------------------------------------------------------------
PyObject* cpyrt::InstanceExecutor::Execute(interop::TCppMethod_t method,
                                           interop::TCppObject_t self,
                                           CallContext* ctxt) {
  // execution will bring a temporary in existence
  interop::TCppObject_t value = GILCallO(method, self, ctxt, fClass);
...
//----------------------------------------------------------------------------
cpyrt::IteratorExecutor::IteratorExecutor(interop::TCppScope_t klass)
    : InstanceExecutor(klass) {
  fFlags |= CPPInstance::kNoMemReg |
            CPPInstance::kNoWrapConv; // adds to flags from base class
}

//----------------------------------------------------------------------------
PyObject* cpyrt::InstanceRefExecutor::Execute(interop::TCppMethod_t method,
                                              interop::TCppObject_t self,
                                              CallContext* ctxt) {
  // executor binds the result to the left-hand side, overwriting if an old
  // object
  ...
  if (!result || !fAssignable)
    ...
    PyObject* res2 =
        PyObject_CallFunction(assign, const_cast<char*>("O"), fAssignable);
...
PyObject* cpyrt::InstancePtrPtrExecutor::Execute(interop::TCppMethod_t method,
                                                 interop::TCppObject_t self,
                                                 CallContext* ctxt) {
  // execute <method> with argument <self, ctxt>, construct python C++ proxy
  // object return ptr value
...
//----------------------------------------------------------------------------
PyObject* cpyrt::InstancePtrRefExecutor::Execute(interop::TCppMethod_t method,
                                                 interop::TCppObject_t self,
                                                 CallContext* ctxt) {
  // execute <method> with argument <self, ctxt>, construct python C++ proxy
  // object ignoring ref) return ptr value
  if (fAssignable && !CPPInstance_Check(fAssignable))
    return SetInstanceCheckError(fAssignable);
...
//----------------------------------------------------------------------------
PyObject* cpyrt::InstanceArrayExecutor::Execute(interop::TCppMethod_t method,
                                                interop::TCppObject_t self,
                                                CallContext* ctxt) {
  // execute <method> with argument <self, ctxt>, construct TupleOfInstances
  // from return value
  return BindCppObjectArray((void*)GILCallR(method, self, ctxt), fClass,
                            {fSize});
}

//----------------------------------------------------------------------------
PyObject* cpyrt::ConstructorExecutor::Execute(interop::TCppMethod_t method,
                                              interop::TCppObject_t klass,
                                              CallContext* ctxt) {
  ...
  return (PyObject*)GILCallConstructor(method, interop::TCppScope_t(klass.data),
                                       ctxt)
      .data;
}

//----------------------------------------------------------------------------
PyObject* cpyrt::PyObjectExecutor::Execute(interop::TCppMethod_t method,
                                           interop::TCppObject_t self,
                                           CallContext* ctxt) {
...
//----------------------------------------------------------------------------
PyObject* cpyrt::FunctionPointerExecutor::Execute(interop::TCppMethod_t method,
                                                  interop::TCppObject_t self,
                                                  CallContext* ctxt) {
  // execute <method> with argument <self, ctxt>, return std::function from func
  // ptr
  ...
  // There's currently now way to return a typed function nullptr, but given
  // that this is a return value (thus can not be set) and overloading function
  // based on function pointer return type is likely uncommon ...
  Py_INCREF(gNullPtrObject);
  return gNullPtrObject;
}

//- factories ----------------------------------------------------------------
cpyrt::Executor* cpyrt::CreateExecutor(const std::string& fullType,
                                       cdims_t dims) {
  // The matching of the fulltype to an executor factory goes through up to 4
  // levels:
  ...
  //
  // If all fails, void is used, which will cause the return type to be ignored
  // on use
  ...
  // simple array types
  if (!cpd.empty() && (std::string::size_type)std::count(cpd.begin(), cpd.end(),
                                                         '*') == cpd.size()) {
    h = gExecFactories.find(realType + " ptr");
    if (h != gExecFactories.end())
      return (h->second)((!dims || dims.ndim() < (dim_t)cpd.size())
                             ? dims_t(cpd.size())
                             : dims);
  }
  ...
  if (interop::TCppScope_t klass = interop::GetFullScope(realType)) {
    if (Utility::IsSTLIterator(realType) ||
        gIteratorTypes.find(fullType) != gIteratorTypes.end()) {
      if (cpd == "")
    ...
    result = new FunctionPointerExecutor(
        ...
        resolvedType.substr(pos2 + 2, pos3 - pos2 - 1));
  } else {
    // unknown: void* may work ("user knows best"), void will fail on use of
    // return value
    h = (cpd == "") ? gExecFactories.find("void")
                    : gExecFactories.find("void ptr");
  }
...
cpyrt::Executor* cpyrt::CreateExecutor(interop::TCppType_t type, cdims_t dims) {
  // The matching of the fulltype to an executor factory goes through up to 4
  // levels:
  //   1) full, qualified match
  //   2) drop '&' as by ref/full type is often pretty much the same python-wise
  ...
  if (fullType.size() >= 2 &&
      fullType.compare(fullType.size() - 2, 2, " &") == 0)
  ...
  interop::TCppType_t resolvedType = interop::ResolveType(type);
  {
    ...
    resolvedType = interop::ResolveEnumReferenceType(resolvedType);
    // similarly for pointers
    resolvedType = interop::ResolveEnumPointerType(resolvedType);
  }
  // FIXME: avoid string comparisons and parsing
  std::string resolvedTypeStr = interop::GetTypeAsString(resolvedType);
  if (interop::IsFunctionPointerType(resolvedType)) {
    resolvedTypeStr.erase(
        std::remove(resolvedTypeStr.begin(), resolvedTypeStr.end(), ' '),
        resolvedTypeStr.end());
    if (resolvedTypeStr.rfind("(void)") != std::string::npos)
      resolvedTypeStr =
          resolvedTypeStr.substr(0, resolvedTypeStr.size() - 6) + "()";
  }
  ...
  interop::TCppType_t realType = interop::IsFunctionPointerType(resolvedType)
                                     ? resolvedType
                                     : interop::GetRealType(resolvedType);
  std::string realTypeStr = interop::IsFunctionPointerType(resolvedType)
                                ? resolvedTypeStr
                                : interop::GetTypeAsString(realType);
  ...
  // C++ classes and special cases
  Executor* result = 0;
  if (interop::IsClassType(realType)) {
    interop::TCppScope_t klass = interop::GetScopeFromType(realType);
    if (resolvedTypeStr.find("iterator") != std::string::npos ||
        gIteratorTypes.find(fullType) != gIteratorTypes.end()) {
      if (cpd == "")
        return new IteratorExecutor(klass);
    }
...
//----------------------------------------------------------------------------
CPYRT_EXPORT
void cpyrt::DestroyExecutor(Executor* p) {
  if (p && p->HasState())
...
//----------------------------------------------------------------------------
CPYRT_EXPORT
bool cpyrt::RegisterExecutor(const std::string& name, ef_t fac) {
...
//----------------------------------------------------------------------------
CPYRT_EXPORT
void* cpyrt::CallVoidP(interop::TCppMethod_t meth, interop::TCppObject_t obj,
                       CallContext* ctxt) {
...
public:
  InitExecFactories_t() {
    ...
    cpyrt::ExecFactories_t& gf = gExecFactories;

    // factories for built-ins
    gf["bool"] = (ef_t) + [](cdims_t) {
      static BoolExecutor e{};
      return &e;
    };
    gf["bool&"] = (ef_t) + [](cdims_t) { return new BoolRefExecutor{}; };
    gf["const bool&"] = (ef_t) + [](cdims_t) {
      static BoolConstRefExecutor e{};
      return &e;
    };
    gf["char"] = (ef_t) + [](cdims_t) {
      static CharExecutor e{};
      return &e;
    };
    gf["signed char"] = gf["char"];
    gf["unsigned char"] = (ef_t) + [](cdims_t) {
      static UCharExecutor e{};
      return &e;
    };
    gf["char&"] = (ef_t) + [](cdims_t) { return new CharRefExecutor{}; };
    gf["signed char&"] = gf["char&"];
    gf["unsigned char&"] =
        (ef_t) + [](cdims_t) { return new UCharRefExecutor{}; };
    gf["const char&"] = (ef_t) + [](cdims_t) {
      static CharConstRefExecutor e{};
      return &e;
    };
    gf["const signed char&"] = gf["const char&"];
    gf["const unsigned char&"] = (ef_t) + [](cdims_t) {
      static UCharConstRefExecutor e{};
      return &e;
    };
    gf["wchar_t"] = (ef_t) + [](cdims_t) {
      static WCharExecutor e{};
      return &e;
    };
    gf["char16_t"] = (ef_t) + [](cdims_t) {
      static Char16Executor e{};
      return &e;
    };
    gf["char32_t"] = (ef_t) + [](cdims_t) {
      static Char32Executor e{};
      return &e;
    };
    gf["int8_t"] = (ef_t) + [](cdims_t) {
      static Int8Executor e{};
      return &e;
    };
    ...
    gf["uint8_t"] = (ef_t) + [](cdims_t) {
      static UInt8Executor e{};
      return &e;
    };
    ...
    gf["short"] = (ef_t) + [](cdims_t) {
      static ShortExecutor e{};
      return &e;
    };
    gf["short&"] = (ef_t) + [](cdims_t) { return new ShortRefExecutor{}; };
    gf["int"] = (ef_t) + [](cdims_t) {
      static IntExecutor e{};
      return &e;
    };
    gf["int&"] = (ef_t) + [](cdims_t) { return new IntRefExecutor{}; };
    gf["unsigned short"] = gf["int"];
    gf["unsigned short&"] =
        (ef_t) + [](cdims_t) { return new UShortRefExecutor{}; };
    gf["unsigned long"] = (ef_t) + [](cdims_t) {
      static ULongExecutor e{};
      return &e;
    };
    gf["unsigned long&"] =
        (ef_t) + [](cdims_t) { return new ULongRefExecutor{}; };
    gf["unsigned int"] = gf["unsigned long"];
    gf["unsigned int&"] =
        (ef_t) + [](cdims_t) { return new UIntRefExecutor{}; };
    gf["long"] = (ef_t) + [](cdims_t) {
      static LongExecutor e{};
      return &e;
    };
    ...
    gf["unsigned long&"] =
        (ef_t) + [](cdims_t) { return new ULongRefExecutor{}; };
    gf["long long"] = (ef_t) + [](cdims_t) {
      static LongLongExecutor e{};
      return &e;
    };
    gf["long long&"] =
        (ef_t) + [](cdims_t) { return new LongLongRefExecutor{}; };
    gf["unsigned long long"] = (ef_t) + [](cdims_t) {
      static ULongLongExecutor e{};
      return &e;
    };
    gf["unsigned long long&"] =
        (ef_t) + [](cdims_t) { return new ULongLongRefExecutor{}; };

    gf["float"] = (ef_t) + [](cdims_t) {
      static FloatExecutor e{};
      return &e;
    };
    gf["float&"] = (ef_t) + [](cdims_t) { return new FloatRefExecutor{}; };
    gf["double"] = (ef_t) + [](cdims_t) {
      static DoubleExecutor e{};
      return &e;
    };
    gf["double&"] = (ef_t) + [](cdims_t) { return new DoubleRefExecutor{}; };
    gf["long double"] = (ef_t) + [](cdims_t) {
      static LongDoubleExecutor e{};
      return &e;
    }; // TODO: lost precision
    gf["long double&"] =
        (ef_t) + [](cdims_t) { return new LongDoubleRefExecutor{}; };
    gf["std::complex<double>"] = (ef_t) + [](cdims_t) {
      static ComplexDExecutor e{};
      return &e;
    };
    gf["std::complex<double>&"] =
        (ef_t) + [](cdims_t) { return new ComplexDRefExecutor{}; };
    gf["void"] = (ef_t) + [](cdims_t) {
      static VoidExecutor e{};
      return &e;
    };

    // pointer/array factories
    gf["void ptr"] =
        (ef_t) + [](cdims_t d) { return new VoidArrayExecutor{d}; };
    gf["bool ptr"] =
        (ef_t) + [](cdims_t d) { return new BoolArrayExecutor{d}; };
    gf["unsigned char ptr"] =
        (ef_t) + [](cdims_t d) { return new UCharArrayExecutor{d}; };
    gf["const unsigned char ptr"] = gf["unsigned char ptr"];
    gf["std::byte ptr"] =
        (ef_t) + [](cdims_t d) { return new ByteArrayExecutor{d}; };
    gf["const std::byte ptr"] = gf["std::byte ptr"];
    gf["int8_t ptr"] =
        (ef_t) + [](cdims_t d) { return new Int8ArrayExecutor{d}; };
    gf["uint8_t ptr"] =
        (ef_t) + [](cdims_t d) { return new UInt8ArrayExecutor{d}; };
    gf["short ptr"] =
        (ef_t) + [](cdims_t d) { return new ShortArrayExecutor{d}; };
    gf["unsigned short ptr"] =
        (ef_t) + [](cdims_t d) { return new UShortArrayExecutor{d}; };
    gf["int ptr"] = (ef_t) + [](cdims_t d) { return new IntArrayExecutor{d}; };
    gf["unsigned int ptr"] =
        (ef_t) + [](cdims_t d) { return new UIntArrayExecutor{d}; };
    gf["long ptr"] =
        (ef_t) + [](cdims_t d) { return new LongArrayExecutor{d}; };
    gf["unsigned long ptr"] =
        (ef_t) + [](cdims_t d) { return new ULongArrayExecutor{d}; };
    gf["long long ptr"] =
        (ef_t) + [](cdims_t d) { return new LLongArrayExecutor{d}; };
    gf["unsigned long long ptr"] =
        (ef_t) + [](cdims_t d) { return new ULLongArrayExecutor{d}; };
    gf["float ptr"] =
        (ef_t) + [](cdims_t d) { return new FloatArrayExecutor{d}; };
    gf["double ptr"] =
        (ef_t) + [](cdims_t d) { return new DoubleArrayExecutor{d}; };
    gf["long double ptr"] =
        (ef_t) + [](cdims_t d) { return new LDoubleArrayExecutor{d}; };
    gf["std::complex<float> ptr"] =
        (ef_t) + [](cdims_t d) { return new ComplexFArrayExecutor{d}; };
    gf["std::complex<double> ptr"] =
        (ef_t) + [](cdims_t d) { return new ComplexDArrayExecutor{d}; };
    gf["std::complex<int> ptr"] =
        (ef_t) + [](cdims_t d) { return new ComplexIArrayExecutor{d}; };
    gf["std::complex<long> ptr"] =
        (ef_t) + [](cdims_t d) { return new ComplexLArrayExecutor{d}; };
    ...
    // We always need these executors when cppjit is based on an unpatched
    ...
    gf["const char*"] = (ef_t) + [](cdims_t) {
      static CStringExecutor e{};
      return &e;
    };
    gf["char*"] = gf["const char*"];
    gf["const char*&"] = (ef_t) + [](cdims_t) {
      static CStringRefExecutor e{};
      return &e;
    };
    gf["char*&"] = gf["const char*&"];
    gf["const signed char*"] = gf["const char*"];
    // gf["signed char*"] =                gf["char*"];
    gf["signed char ptr"] =
        (ef_t) + [](cdims_t d) { return new SCharArrayExecutor{d}; };
    gf["wchar_t*"] = (ef_t) + [](cdims_t) {
      static WCStringExecutor e{};
      return &e;
    };
    gf["char16_t*"] = (ef_t) + [](cdims_t) {
      static CString16Executor e{};
      return &e;
    };
    gf["char32_t*"] = (ef_t) + [](cdims_t) {
      static CString32Executor e{};
      return &e;
    };
    gf["std::basic_string<char>"] = (ef_t) + [](cdims_t) {
      static STLStringExecutor e{};
      return &e;
    };
    gf["std::basic_string<char>&"] =
        (ef_t) + [](cdims_t) { return new STLStringRefExecutor{}; };
    gf["std::basic_string<wchar_t>"] = (ef_t) + [](cdims_t) {
      static STLWStringExecutor e{};
      return &e;
    };
    gf[WSTRING1] = gf["std::basic_string<wchar_t>"];
    gf[WSTRING2] = gf["std::basic_string<wchar_t>"];
    gf["__init__"] = (ef_t) + [](cdims_t) {
      static ConstructorExecutor e{};
      return &e;
    };
    gf["PyObject*"] = (ef_t) + [](cdims_t) {
      static PyObjectExecutor e{};
      return &e;
    };
